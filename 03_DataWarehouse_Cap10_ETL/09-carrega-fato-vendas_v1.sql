...
-- (sk_produto, sk_cliente, sk_canal, sk_data)=(1, 9, 2, 808)

-- Check - Obs: Os códigos abaixo podem ser diferentes no seu ambiente

SELECT * FROM schema3.fato_vendas where sk_data = 808 and sk_cliente = 9 order by 1;
...
WHERE sk_data = 808 AND sk_cliente = 9
