...
-- EXPLICAÇÃO DA QUERY ACIMA:

-- random() * 9999 + 1)::INT:
-- -- random() gera um número decimal entre 0 e 1.
-- -- Multiplicamos por 9999 para obter um número entre 0 e 9999.
-- -- Somamos 1 para garantir que nunca seja 0.
-- -- ::INT converte para número inteiro.

-- NOW() - (random() * 365 * INTERVAL '1 day')
-- -- NOW() retorna a data e hora atuais.
-- -- (random() * 365 * INTERVAL '1 day') gera um número aleatório de dias até 365 dias atrás.
-- -- Subtrai esse valor de NOW(), criando datas aleatórias no último ano.

--  WHEN random() < 0.5 THEN 'concluido'
    --ELSE 'pendente'
-- -- random() gera um número entre 0 e 1.
-- -- Se for menor que 0.5, define como 'concluido'.
-- -- Caso contrário, 'pendente'.
-- -- Isso faz com que aproximadamente 50% dos pedidos sejam concluídos.
