...
-- View materializada
-- Ela grava o resultado como tabela. Dessa forma não é preciso executar a query toda vez que precisa desses dados.
-- A desvantagem é que ela não retorna os resultados em tempo real, como na View.
-- O ideal é fazer o REFRESH dessa View Materializada periodicamente, tipo 1x por dia.
-- A vantagem é que o processo é muito mais leve do que ficar executando query em tempo real o tempo todo, começa a ser muito lento.
