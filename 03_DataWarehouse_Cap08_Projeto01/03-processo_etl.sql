    ...
    WHILE i <= 1000 LOOP
        ...
        BEGIN
            ...
            VALUES (
                ...
                -- RANDOM() * 125 multiplica o valor aleatório por 125, criando um número aleatório entre 0 e 124,99...
                -- 1 + RANDOM() * 125 adiciona 1 ao resultado anterior, mudando o intervalor para algo entre 1 e 125,999...
                -- FLOOR() arredonda o valor para baixo (piso), transformando o número em um inteiro entre 1 e 125
