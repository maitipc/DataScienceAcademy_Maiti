...
# Este script cria duas tabelas idênticas com datas e incremento das datas.
# Porém, a forma de criação das duas é totalmente diferente.
# Na primeira, é criada puramente com sintaxe apache spark.
# Na segunda, é criada com linguagem SQL.
