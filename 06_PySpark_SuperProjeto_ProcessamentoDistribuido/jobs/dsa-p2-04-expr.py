# DSA Projeto 2 - Script 04 - Expr - Manipulando Expressões
...
# Usa o || para concatenenar as colunas Nome e Sobrenome, incluindo um espaço vazio entre elas
# e atribui esse valor a coluna NomeCompleto
