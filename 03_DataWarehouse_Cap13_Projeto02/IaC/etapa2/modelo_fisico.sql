...
FROM 's3://dsa-fonte-p2-SEU_ID_AWS/dados/dim_cliente.csv'
IAM_ROLE 'arn:aws:iam::SEU_ID_AWS:role/RedshiftS3AccessRole'
CSV;

COPY dsaschema.dim_localidade
FROM 's3://dsa-fonte-p2-SEU_ID_AWS/dados/dim_localidade.csv'
IAM_ROLE 'arn:aws:iam::SEU_ID_AWS:role/RedshiftS3AccessRole'
CSV;

COPY dsaschema.dim_produto
FROM 's3://dsa-fonte-p2-SEU_ID_AWS/dados/dim_produto.csv'
IAM_ROLE 'arn:aws:iam::SEU_ID_AWS:role/RedshiftS3AccessRole'
CSV;

COPY dsaschema.dim_tempo
FROM 's3://dsa-fonte-p2-SEU_ID_AWS/dados/dim_tempo.csv'
IAM_ROLE 'arn:aws:iam::SEU_ID_AWS:role/RedshiftS3AccessRole'
CSV;

COPY dsaschema.fato_vendas
FROM 's3://dsa-fonte-p2-SEU_ID_AWS/dados/fato_vendas.csv'
IAM_ROLE 'arn:aws:iam::SEU_ID_AWS:role/RedshiftS3AccessRole'
CSV;
