...
FROM cap03.funcionarios
GROUP BY departamento
-- o HAVING é um filtro depois do GROUP BY, pq a média só vai ser executada depois do GROUP BY. 
-- Por isso não teria como filtrar com o WHERE, já que ele é executado antes do GROUP BY, 
-- e nesse caso a média não teria sido feita ainda.
